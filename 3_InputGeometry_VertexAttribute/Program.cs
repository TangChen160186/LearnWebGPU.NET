...
namespace _3_InputGeometry_VertexAttribute
{
    internal unsafe class Program
    {
        ...
        private static void WindowRender(double obj)
        {
            ...
            _wgpu.RenderPassEncoderDraw(renderPass,6,1,0,0);
        ...
        private static void InitializeBuffers()
        {
            ...
            _vertexBuffer = _wgpu.DeviceCreateBuffer(_device, bufferDescriptor);
