...
namespace _1_Transformation
{
    ...
    struct UniformData
    {
        ...
        [FieldOffset(16)] public Matrix4x4 Model;
        [FieldOffset(80)] public Matrix4x4 View;
        [FieldOffset(144)] public Matrix4x4 Projection;
    }
    ...
    internal unsafe class Program
    {
        ...
        private static void WindowRender(double obj)
        {
            ...
            _modelMat *= Matrix4x4.CreateRotationZ((float)(Math.PI * 1 / 180f)) ;
            data.View = Matrix4x4.CreateLookAt(new Vector3(0,0,1),Vector3.Zero, Vector3.UnitY);
            data.Projection =
                Matrix4x4.CreateOrthographic(_window.FramebufferSize.X, _window.FramebufferSize.Y, 0.1f, 1000f);
